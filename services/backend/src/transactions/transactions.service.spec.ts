...
describe('TransactionsService', () => {
  ...
  describe('findOneTransaction', () => {
    it('should return a transaction by id', async () => {
      ...
      const result = await service.findOneTransaction(
        mockUserId,
        mockTransactionId
      )
    ...
    it('should throw NotFoundException if transaction not found', async () => {
      ...
      await expect(
        service.findOneTransaction(mockUserId, 'non-existent')
    ...
    it('should throw ForbiddenException if user does not own the transaction', async () => {
      ...
      await expect(
        service.findOneTransaction(mockUserId, mockTransactionId)
  ...
  describe('deleteTransaction', () => {
    ...
    it('should throw NotFoundException if transaction not found', async () => {
      ...
      await expect(
        service.deleteTransaction(mockUserId, 'non-existent')
      ).rejects.toThrow(NotFoundException)
    })
  ...
  describe('findOneCategory', () => {
    ...
    it('should throw NotFoundException if category not found', async () => {
      ...
      await expect(
        service.findOneCategory(mockUserId, 'non-existent')
      ).rejects.toThrow(NotFoundException)
    })
    ...
    it('should throw ForbiddenException if user does not own the category', async () => {
      ...
      await expect(
        service.findOneCategory(mockUserId, mockCategoryId)
      ).rejects.toThrow(ForbiddenException)
    })
  })
