...
export function OAuthButton({
  ...
  return (
    <button
      ...
      className={cn(
        'flex w-full items-center justify-center gap-3 rounded-lg border-2 px-4 py-3 text-sm font-semibold transition-all duration-200',
        ...
        config.textColor,
        config.hoverBgColor,
        provider === 'google' && 'border-gray-200 dark:border-gray-700'
      )}
    >
      {isLoading ? (
