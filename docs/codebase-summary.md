...
**Last Updated:** January 21, 2026 | **Generated By:** Scout Reports + Repomix Analysis

---

## Executive Overview

M-Tracking is a **39,000+ LOC monorepo** organized with Nx into 3 workspaces:

- **apps/frontend** (9,851 LOC) - Next.js 16 web dashboard
- **services/backend** (5,616 LOC) - NestJS modular monolith
- **services/analytics** (88 LOC) - FastAPI LLM service
- **libs/** (4,000+ LOC) - Shared types, constants, utilities, configs

**Tech Stack:** TypeScript + React 19 + NestJS 11 + FastAPI + PostgreSQL 17 + Redis 7
...
- Next.js 16 application with 138 files, 9,851 LOC
- Feature-based architecture with auth, spending, profile, preferences modules
...
- NestJS modular monolith with 598 files, 5,616 LOC
- 2 implemented modules: Auth (~600 LOC), Transactions (~800 LOC)
- 3 placeholder modules: Banking, Budgets, Notifications
- PostgreSQL 17 database with TypeORM ORM
- Redis for caching, RabbitMQ for job queues

**Analytics** (services/analytics):

- FastAPI Python service (9 files, 88 LOC)
- Early-stage implementation for LLM operations
- OpenAI/Anthropic API integration ready
- Redis cache integration
- Async database drivers (asyncpg, SQLAlchemy)

**Shared Libraries** (libs/):

- @m-tracking/types - Shared TypeScript interfaces
- @m-tracking/constants - Application constants
- @m-tracking/utils - Utility functions
- @m-tracking/common - Error definitions, validation patterns
- Config libraries - ESLint, TypeScript, Prettier profiles
